...
def sum_of_squared_errors(alpha, beta, x, y):
    """because just summing errors can cancel things out"""
...
def r_squared(alpha, beta, x, y):
    ...
    which equals 1 - the fraction of variation in y not captured by
    the model"""
    return 1.0 - \
        (sum_of_squared_errors(alpha, beta, x, y) / total_sum_of_squares(y))


def sqared_error(x_i, y_i, theta):
    alpha, beta = theta
