...
class TestKnn(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cities = [([longitude, latitude], language)
    ...
    def test_knn_classify(self):
        ...
        for k in [1, 3, 5, 7]:
            ...
            for city in self.cities:
                ...
                predicted_language = knn.knn_classify(k,
                                                      other_cities,
                                                      location)
            ...
            results[k] = num_correct
            message = "{0} neighbor[s]: {1} correct out of {2}"
            logging.debug(message.format(k, num_correct, len(self.cities)))

        expected = {1: 40, 3: 44, 5: 41, 7: 35}
        for k in results:
            self.assertEqual(results[k], expected[k])
